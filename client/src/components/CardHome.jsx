...
export default function CardHome({data, loading, error}) {
  // console.log(data.__typename, '<<<<<<< DATA MOVIE' );
          ...
          <article className="overflow-hidden rounded-lg shadow-lg">    
            ...
            <footer className="flex items-center justify-between leading-none p-2 md:p-4">
              ...
              <div className=''>
                ...
                <button onClick={() => handleDelete(data._id)} type="button" className="mx-2 py-2 px-4 bg-transparent text-white font-semibold rounded bg-red-600 hover:bg-red-800 hover:text-white hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0 transform hover:scale-110">Delete</button>
                <button onClick={() => handleEdit(data._id)} type="button" className="mx-2 py-2 px-4 bg-transparent text-white font-semibold rounded bg-yellow-600 hover:bg-yellow-800 hover:text-white hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0 transform hover:scale-110">Edit</button>
              </div>
